        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="mx-auto d-block">
                    ...
                    <div class="location text-sm-center"><i class="fas fa-fw fa-users mx-2"></i> <%= rs.getString(4) %></div>
                    <div class="location text-sm-center"><i class="fas fa-fw fa-envelope mx-2"></i> <%= rs.getString(5) %></div>
                </div>
            </div>
        </div>
        <%
