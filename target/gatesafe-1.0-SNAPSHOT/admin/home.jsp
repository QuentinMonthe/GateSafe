                        ...
                        <div class="col-xl-10 col-md-8">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Active user sessions</h6>
                                </div>
                                <div class="card-body">
                                        ...
                                        <table class="table table-bordered" id="dataTable" style="width: 100%" width="100%" cellspacing="0">
                                            ...
                                            <%
                                                try {
                                                    ...
                                                    ResultSet rs = st.executeQuery("select * from login where date_login = date_logout order by date_login desc");
                                                    ResultSet result;
                                            ...
                                            %>
                                                <tr>
                                                    ...
                                                    <td >
                                                        <span class="p-1 rounded bg-gradient-success text-white">online</span>
                                                    </td>
                                                </tr>
                                            <%
